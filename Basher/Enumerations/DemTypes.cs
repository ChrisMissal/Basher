...
namespace Basher.Enumerations
{
    internal class DemTypes : Enumeration<DemTypes, ulong>
    {
        ...
        public static DemTypes CDemoFullPacket = new DemTypes(EDemoCommands.DemFullPacket, global::CDemoFullPacket.Descriptor, true);
        ...
        private DemTypes(EDemoCommands value, MessageDescriptor descriptor, bool hasEmbeddedData = false) : base((ulong) value, descriptor.Name)
        {
            this.Descriptor = descriptor;
            this.HasEmbeddedData = hasEmbeddedData;
        }
